...
files_to_include = [['Hong_0_updated.yaml'],
                    ...
                    ['Hong_HO2_fake_data_0_updated.yaml','Hong_HO2_fake_data_0_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_1_updated.yaml','Hong_HO2_fake_data_1_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_2_updated.yaml','Hong_HO2_fake_data_2_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_3_updated.yaml','Hong_HO2_fake_data_3_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_4_updated.yaml','Hong_HO2_fake_data_4_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_5_updated.yaml','Hong_HO2_fake_data_5_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_6_updated.yaml','Hong_HO2_fake_data_6_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_7_updated.yaml','Hong_HO2_fake_data_7_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_8_updated.yaml','Hong_HO2_fake_data_8_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_9_updated.yaml','Hong_HO2_fake_data_9_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_10_updated.yaml','Hong_HO2_fake_data_10_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_11_updated.yaml','Hong_HO2_fake_data_11_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_12_updated.yaml','Hong_HO2_fake_data_12_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_13_updated.yaml','Hong_HO2_fake_data_13_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_14_updated.yaml','Hong_HO2_fake_data_14_abs_updated.yaml'],
                    ['Hong_HO2_fake_data_15_updated.yaml','Hong_HO2_fake_data_15_abs_updated.yaml']] 
#
#files_to_include = [['Hong_0.yaml'],
#                    ['Hong_2.yaml'],
#                    ['Hong_3.yaml'],
...
cti_file = 'FFCM1_custom_updated_temp.cti'
working_directory = 'MSI/data/hong_H2O2_fake_data'
reaction_uncertainty_csv = 'FFCM1_reaction_uncertainty.csv'
master_reaction_equation_cti_name = 'master_reactions_FFCM1_updated.cti'
