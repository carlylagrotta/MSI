...
cti_file = 'chem_calories_extra_reaction.cti'
...
master_equation_reactions = ['H2O2(13) + OH(8) <=> H2O(10) + HO2(12)',
                             'HO2(12) + OH(8) <=> H2O(10) + O2(6)',
                             '2 OH(8) <=> H2O(10) + O(7)',
                             'CH3(20) + HO2(12) <=> CH4(32) + O2(6)',
                             'CH3(20) + HO2(12) <=> CH3O(28) + OH(8)']
...
six_parameter_fit_sensitivities = {'H2O2(13) + OH(8) <=> H2O(10) + HO2(12)':{'A':np.array([-13.37032086,	32.42060027,	19.23022032,	6.843287462	, 36.62853824	,-0.220309785	,-0.099366346,	-4.134352081]),
                                    ...
                                    'HO2(12) + OH(8) <=> H2O(10) + O2(6)': {'A':np.array([-4.795727446,	6.426354909	,4.878258417,	2.472791017,	7.856296474,	1.328033302	,-3.457932692,	-0.349839371,	2.331070924	,2.403555921,	-0.165397001,	0.246540172	,0.722946077]),
                                    ...
                                    '2 OH(8) <=> H2O(10) + O(7)':      {'A': np.array([-5.40485067,	18.96061659	,8.089301961,	6.953940096	,-12.54280438,	-3.264972401,	2.106487623	,-1.657943467,	1.614935	,-1.536463599]),
                                    ...
                                    'CH3(20) + HO2(12) <=> CH4(32) + O2(6)': {'A':np.array([.007845,-.89278,-.94908]),
                                                               'n':np.array([-0.00104,-.36888,.154462]),
                                                               'Ea':np.array([.504278,-.44379,-0.03181]),
                                                               'c':np.array([0,0,0]),
                                                               'd':np.array([0,0,0]),
                                                               'f':np.array([0,0,0])},
                                    'CH3(20) + HO2(12) <=> CH3O(28) + OH(8)': {'A':np.array([1.319108,-.92151]),
...
molecular_parameter_sensitivities = {'H2O2(13) + OH(8) <=> H2O(10) + HO2(12)':{'A':np.array([-0.373074255,	-5.658058364,-2.203911028,1.69333527,-7.110529947,-0.272049596,1.373125254,-0.644666166]),
                                    ...
                                    'HO2(12) + OH(8) <=> H2O(10) + O2(6)': {'A':np.array([-1.30109642,	-11.63457509,	-4.680271526,	0.782373804	, -0.016083278,	0.005513255	,-1.738426278,	-0.232013539,	0.884067816	,-0.500473791,	0.399272687	,0.062255923	,-1.667253993]),
                                    ...
                                    '2 OH(8) <=> H2O(10) + O(7)':      {'A': np.array([0.299144373,	-2.662684629,	-6.643003014,	0.370230493	,-3.354253502,	-0.271981922,	-0.581195748,	9.774024441	, 5.90328859,	2.272800133]),
...
six_parameter_fit_nominal_parameters_dict = {'H2O2(13) + OH(8) <=> H2O(10) + HO2(12)':{'A':4.64E-06,'n':5.605491008,'Ea':-5440.266692,'c':126875776.1,'d':0.000441194,'f':-5.35E-13},
                                 'HO2(12) + OH(8) <=> H2O(10) + O2(6)':{'A':1.41E+18,'n':-2.05344973,'Ea':-232.0064051,'c':15243859.12,'d':-0.001187694,'f':8.01E-12},
                                 '2 OH(8) <=> H2O(10) + O(7)':{'A':354.5770856,'n':2.938741717,'Ea':-1836.492972,'c':12010735.18,'d':-4.87E-05,'f':1.22E-12},
                                 'CH3(20) + HO2(12) <=> CH4(32) + O2(6)':{'A':3.19e3,'n':2.670857,'Ea':-4080.73,'c':0.0,'d':0.0,'f':0.0},
                                 'CH3(20) + HO2(12) <=> CH3O(28) + OH(8)':{'A':8.38e11,'n':.29,'Ea':-785.45,'c':0.0,'d':0.0,'f':0.0}}
