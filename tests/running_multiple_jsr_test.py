...
test_p = pr.Processor('C:\\Users\\HP USER\\Google Drive\\Burke Group\\Codes\\Mechanisms\\FFCM-1\\FFCM1.cti')
yaml_file_list = [('C:\\Users\\HP USER\\Google Drive\\Burke Group\\Mark\\MSI\\data\\yaml_files\\JSR_template_new.yaml',)]
