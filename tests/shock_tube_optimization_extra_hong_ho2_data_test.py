...
##############################################################################################################
#reaction_uncertainty_csv = 'FFCM1_reaction_uncertainty_kinetics_off.csv'
##############################################################################################################
...
##############################################################################################################
#master_equation_uncertainty_df = pd.read_csv('MSI/data/hong_H2O2_fake_data/six_parameter_fit_uncertainty_df_kinetics_off.csv')
##############################################################################################################
#this could be 'On'
