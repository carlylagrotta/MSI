...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 28 14:05:29 2019
...
#files_to_include = [['Troe_4.yaml','Troe_4_abs_sens_test.yaml'],
#                    ['Troe_5.yaml','Troe_5_abs_sens_test.yaml']]
#[['Hong_1_old_code_replication.yaml'],
#                    ['Hong_2_old_code_replication.yaml'],
#                    ['Hong_3_old_code_replication.yaml'],
#                    ['Troe_4_old_code_replication.yaml','Troe_4_abs.yaml'],
#                    ['Troe_5_old_code_replication.yaml','Troe_5_abs.yaml'],
#                    ['Troe_6_old_code_replication.yaml','Troe_6_abs.yaml'],
#                    ['Troe_7_old_code_replication.yaml','Troe_7_abs.yaml'],
#                    ['Troe_8_old_code_replication.yaml','Troe_8_abs.yaml'],
#                    ['Hong_4_old_code_replication.yaml','Hong_4_abs.yaml'],
#                    ['Hong_5.yaml','Hong_5_abs.yaml'],
#                    ['sir_1.yaml'],
#                    ['Hong_6.yaml','Hong_6_high_temp_abs.yaml']]  
# 
#files_to_include = [['Hong_1.yaml'],
#                    ['Hong_2.yaml'],
#                    ['Hong_3.yaml'],
#                    ['Troe_4.yaml','Troe_4_abs.yaml'],1
#                    ['Troe_5.yaml','Troe_5_abs.yaml'],
#                    ['Troe_6.yaml','Troe_6_abs.yaml'],
#                    ['Troe_7.yaml','Troe_7_abs.yaml'],
#                    ['Troe_8.yaml','Troe_8_abs.yaml'],
...
cti_file = 'FFCM1_custom_burke_code_reproduction.cti'
working_directory = 'MSI/data/test_data'
reaction_uncertainty_csv = 'FFCM1_reaction_uncertainty_burke_code_reproduction.csv'
master_reaction_equation_cti_name = 'master_reactions_FFCM1_burke_code_reproduction.cti'
...
master_equation_uncertainty_df = pd.read_csv('MSI/data/test_data/six_parameter_fit_uncertainty_df_burke.csv')
#this could be 'On'
...
six_parameter_fit_sensitivities = {'H2O2 + OH <=> H2O + HO2':{'A':np.array([-13.37032086,	32.42060027,	19.23022032,	6.843287462	, 36.62853824	,-0.220309785	,-0.099366346,	-4.134352081]),
                                    ...
                                    'CH3 + HO2 <=> CH3O + OH': {'A':np.array([1.319108,-.92151]),
                                                                ...
                                                                'd':np.array([0,0]),
                                                                'f':np.array([0,0])},
                                    '2 OH (+M) <=> H2O2 (+M)':{'A':np.array([1,0,0]),
                                                               'n':np.array([0,1,0]),
                                                               'Ea':np.array([0,0,1]),
                                                               'c':np.array([0,0,0]),
                                                               'd':np.array([0,0,0]),
...
six_parameter_fit_nominal_parameters_dict = {'H2O2 + OH <=> H2O + HO2':{'A':4.64E-06,'n':5.605491008,'Ea':-5440.266692,'c':126875776.1,'d':0.000441194,'f':-5.35E-13},
                                '2 HO2 <=> H2O2 + O2':{'A':1.30E+04,'n':1.997152351,'Ea':-3628.04407,'c':93390973.44,'d':-0.000732521,'f':8.20E-12} ,
                                 ...
                                 '2 OH (+M) <=> H2O2 (+M)':{'A':5.030000e+12,'n':0.058,'Ea':-634.33,'c':0.0,'d':0.0,'f':0.0}}
...
MSI_st_instance_two_new = stMSIspf.MSI_shocktube_optimization_six_parameter_fit(cti_file,
                                                   .01,
                                                   1,
                                                   1,
                                                   working_directory,
...
delta_X_list = MSI_st_instance_two_new.multiple_shock_tube_runs(numer_of_iterations)


deltaXAsNsEas = MSI_st_instance_two_new.deltaXAsNsEas
physical_obervable_updates_list = MSI_st_instance_two_new.physical_obervable_updates_list
absorbance_observables_updates_list = MSI_st_instance_two_new.absorbance_coef_update_dict
Ydf = MSI_st_instance_two_new.Y_data_frame
Zdf = MSI_st_instance_two_new.z_data_frame
experimental_dicts = MSI_st_instance_two_new.experiment_dictonaries
z_matrix = MSI_st_instance_two_new.z_matrix
s_matrix = MSI_st_instance_two_new.s_matrix
y = MSI_st_instance_two_new.y_matrix
Y_matrix = MSI_st_instance_two_new.Y_matrix
S_matrix = MSI_st_instance_two_new.S_matrix

X = MSI_st_instance_two_new.X
Xdf = MSI_st_instance_two_new.X_data_frame
covarience = MSI_st_instance_two_new.covarience
exp_dict_list_optimized_new = MSI_st_instance_two_new.experiment_dictonaries
parsed_yaml_list = MSI_st_instance_two_new.list_of_parsed_yamls
sigma = MSI_st_instance_two_new.sigma
X = MSI_st_instance_two_new.X
delta_X = MSI_st_instance_two_new.delta_X
molecular_parameter_updates = MSI_st_instance_two_new.delta_x_molecular_params_by_reaction_dict
nominal_dict_six_p_fit  = MSI_st_instance_two_new.six_paramter_fit_nominal_parameters_dict
...
original_cti_file = MSI_st_instance_two_new.data_directory +'/'+ MSI_st_instance_two_new.cti_file_name

experiment_dict_uncertainty = MSI_st_instance_two_new.experiment_dict_uncertainty_original
target_value_csv = MSI_st_instance_two_new.data_directory +'/'+ MSI_st_instance_two_new.k_target_values_csv
six_parameter_fit_dict_optimized = MSI_st_instance_two_new.updated_six_parameter_fits_dict
if run_with_k_target_values == 'On' or run_with_k_target_values == 'on':
    k_target_value_S_matrix = MSI_st_instance_two_new.k_target_values_for_s
else:
...
plotting_instance = plotter.Plotting(S_matrix,
                                     ...
                                     original_covariance,
                                     S_matrix_original,
                                     exp_dict_list_optimized_new,
                                     exp_dict_list_original,
                                     parsed_yaml_list,
                                     Ydf,
                                     target_value_rate_constant_csv= MSI_st_instance_two_new.data_directory +'/'+ rate_constant_target_value_data_for_plotting ,
                                     target_value_rate_constant_csv_extra_values = MSI_st_instance_two_new.data_directory +'/'+rate_constant_target_value_data_extra,
...
sigmas_optimized_new,test = plotting_instance.calculating_sigmas(S_matrix,covarience)
sigmas_original,test2 = plotting_instance.calculating_sigmas(S_matrix_original,original_covariance)
plotting_instance.plotting_observables(sigmas_original = sigmas_original,sigmas_optimized= sigmas_optimized_new)
...
plotting_instance.plotting_rate_constants_six_paramter_fit(optimized_cti_file=MSI_st_instance_two_new.new_cti_file,
                                original_cti_file=original_cti_file,
                               initial_temperature=250,
                                final_temperature=2500,
                                master_equation_reactions = master_equation_reactions,
...
post_processor_instance = post_processor.post_processing(optimized_cti_file = MSI_st_instance_two_new.new_cti_file,
                                                    original_cti_file = original_cti_file,
                                                    kinetic_paramter_dictonary = MSI_st_instance_two_new.kinetic_paramter_dict,
                                                    master_equation_reactions=master_equation_reactions,
                                                    ...
                                                    exp_dict_list_optimized = exp_dict_list_optimized_new,
