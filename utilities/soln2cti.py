#Author: Parker Clayton
#Obtained from Cantera Users Forum on August 3, 2016
            ...
            if equation_type == 'ThreeBodyReaction':
                ...
                for key in efficiencies.keys():
                    if key in species_names:
                        temp[key] = efficiencies[key]
                trimmed_efficiencies = temp
                efficiencies = temp
                ...
                if equation_object.duplicate is True:
                    reaction_string = Template(
                            ...
                            '       efficiencies = $Efficiencies, options = \'duplicate\') \n\n'
                            )
<<<<<<< HEAD
                    if equation_object.allow_negative_pre_exponential_factor is True:
                        reaction_string = Template(
                            '#  Reaction $m\n'
                            'three_body_reaction( \"$equation_string\",  $Arr,\n'
                            '       efficiencies = $Efficiencies, options = [\'negative_A\',\'duplicate\') \n\n'
                            ) 
...
>>>>>>> f1481addf2130afeceaf2e09ed855c3bf1a0fdf0
            ...
            if equation_type == 'FalloffReaction':
                ...
                if trimmed_efficiencies!={}:
                    ...
                    if equation_object.duplicate==True:
                        reaction_string = Template(
                            '#  Reaction $m\n' +
                            'falloff_reaction( \"$equation_string\",\n' +
                            '        kf = $kf,\n' +
                            '        kf0   = $kf0, options = \'duplicate\''
                            )
                    else:
                        reaction_string = Template(
                            '#  Reaction $m\n' +
